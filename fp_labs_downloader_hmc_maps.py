...
python fp_labs_downloader_hmc_maps.py -settings_file configuration.json
...
# -------------------------------------------------------------------------------------
# Script Main
def main(file_name_settings_default="fp_labs_downloader_hmc_maps.json"):
