...
from library.common.lib_info_args import logger_name as logger_name_default
from library.common.lib_info_args import logger_file as logger_file_default
from library.common.lib_info_args import logger_handle as logger_handle_default
from library.common.lib_info_args import logger_format as logger_formatter_default
...
def set_logging_file(logger_file=logger_file_default, logger_name=logger_name_default,
    ...
    if '$HOME' in logger_file:
        logger_home = os.path.expanduser('~')
        logger_file = logger_file.replace('$HOME', logger_home)
